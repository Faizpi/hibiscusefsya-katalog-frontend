...
const ChatBot = () => {
  ...
  const whatsappLink = 'https://wa.me/6281234567890?text=Halo%20Hibiscus%20Efsya%2C%20saya%20butuh%20bantuan'

  // Quick suggestions
  const quickSuggestions = [
    { text: '📦 Lihat produk unggulan', query: 'produk unggulan' },
    { text: '🏷️ Kategori produk', query: 'kategori apa saja' },
    { text: '💰 Harga produk', query: 'berapa harga' },
    { text: '📍 Cara beli', query: 'cara beli produk' },
    ...
    <>
      ...
      <div className={`chatbot-window ${isOpen ? 'open' : ''}`}>
        ...
        >
          ...
          Chat WhatsApp untuk bantuan lebih lanjut
        </a>
